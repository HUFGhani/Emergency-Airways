package io.github.hufghani.ntsp_uom.utils;
...
public class HtmlTagHandler implements TagHandler {
    ...
    public void handleTag(boolean opening, String tag, Editable output, XMLReader xmlReader) {
        Logcat.m15i(TAG, (opening ? "Opening" : "Closing") + " tag " + tag, new Object[0]);
    ...
    private void handleListTag(Editable output) {
        String[] split;
        if (((String) this.listParents.lastElement()).equals("ul")) {
            output.append("\n");
        ...
        } else if (((String) this.listParents.lastElement()).equals("ol")) {
            this.listItemCount++;
            output.append("\n");
            split = output.toString().split("\n");
